...
class DDPG(object):
	...
	def _build_a(self, s, scope, trainable):
		with tf.variable_scope(scope):
			net = tf.layers.dense(
				s, 300, activation=tf.nn.relu, name='l1', trainable=trainable)
			net2 = tf.layers.dense(net, 100, activation=tf.nn.relu, name='l2', trainable=trainable)
			a = tf.layers.dense(net2, 50, activation=tf.nn.relu,
	...
	def _build_c(self, s, a, scope, trainable):
		with tf.variable_scope(scope):
			...
			net2 = tf.layers.dense(net, 100, activation=tf.nn.relu, name='c1', trainable=trainable)
			c = tf.layers.dense(net2, 10, activation=tf.nn.tanh,
